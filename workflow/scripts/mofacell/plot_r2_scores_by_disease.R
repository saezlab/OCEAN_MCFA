...
if (exists("snakemake")){
  ...
  r2_total <- read.csv("results/mofacell/r2_total~Julio_OCEAN_Nereid~sn10x.csv")
  plt <- 'plots/mofacell/scores_r2_boxplot_by_disease~Julio_OCEAN_Nereid~sn10x.pdf'
  ggs <- 'results/mofacell/scores_r2_boxplot_by_disease~Julio_OCEAN_Nereid~sn10x.rds'
}
